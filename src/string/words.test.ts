...
Deno.test('should work with compound words', function() {
  ...
  assertEquals(words('LETTERSAeiouAreVowels'), ['LETTERS', 'Aeiou', 'Are', 'Vowels']);
...
Deno.test('should work with compound words containing diacritical marks', function() {
  assertEquals(words('LETTERSÆiouAreVowels'), ['LETTERS', 'Æiou', 'Are', 'Vowels']);
...
Deno.test('should prevent ReDoS', function() {
  ...
  assertEquals(words(largeWord + 'ÆiouAreVowels'), [largeWord, 'Æiou', 'Are', 'Vowels']);
